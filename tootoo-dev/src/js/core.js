...
/* ── generated letter-mark favicon from CONFIG.faviconLetters / faviconColor
   (reference §11). This is the fallback behind brandMarkSrc(): used for the tab icon
   and the header/footer/sidebar brand marks whenever no real favicon.ico is found. ── */
