...
* 2026-05-18 — New Tab now opens data/media files such as `.csv` through raw URLs instead of GitHub Pages, and opens the tab synchronously to avoid popup blockers
